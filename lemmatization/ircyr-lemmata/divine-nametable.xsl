        ...
        <body>
            <xsl:variable name="gods" >
                <xsl:for-each select="//file">
                    ...
                    <xsl:for-each
                        select="document($filename)//t:div[@type='edition']//t:persName[@type='divine']//t:name|document($filename)//t:div[@type='edition']//t:persName[@type='divine']//t:w">
            ...
            <xsl:for-each-group select="$gods//token"
                ...
                <word>
                    ...
                    <allnymrefs>
                        <xsl:for-each-group
                            select="$gods//name[translate(normalize-space(.), ' ', '')=translate(normalize-space(current()), ' ', '')]"
