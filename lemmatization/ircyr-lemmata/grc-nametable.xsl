        ...
        <body>
            <xsl:variable name="lemmata" >
                <xsl:for-each select="//file">
                    ...
                    <xsl:for-each
                        select="document($filename)//t:div[@type='edition']//t:name[ancestor-or-self::t:*[@xml:lang][1][@xml:lang='grc'] and not(child::t:seg[@part=('F','I','M')])]">
            ...
            <xsl:for-each-group select="$lemmata//name"
